...
import 'package:gps_software/screens/bottomBar/module/vehicleList/module/vehicle_reports/widget/geofence_report_card.dart';
...
class GeofenceReportView extends GetView<VehicleListViewModel> {
  static const geofenceReportView = '/geofenceReportView';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AccountModuleAppBar(
        title: AppStrings.geofenceReport,
        action: VehicleReportAppBarActions(
          onDownload: controller.onGeofenceReportDownload,
          onCalendar: controller.showVehicleReportDateSelectionDialog,
        ),
      ),
      body: ListView.builder(
        padding: EdgeInsets.only(top: 12.h, bottom: 16.h),
        itemCount: controller.geofenceReportItems.length,
        itemBuilder: (context, index) {
          return GeofenceReportCard(
            report: controller.geofenceReportItems[index],
          );
        },
      ),
    );
