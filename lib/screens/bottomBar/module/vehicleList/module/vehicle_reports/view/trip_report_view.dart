...
import 'package:gps_software/screens/bottomBar/module/vehicleList/module/vehicle_reports/widget/trip_report_card.dart';
...
class TripReportView extends GetView<VehicleListViewModel> {
  static const tripReportView = '/tripReportView';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AccountModuleAppBar(
        title: AppStrings.tripReport,
        action: VehicleReportAppBarActions(
          onDownload: controller.onTripReportDownload,
          onCalendar: controller.showVehicleReportDateSelectionDialog,
        ),
      ),
      body: ListView.builder(
        padding: EdgeInsets.only(top: 12.h, bottom: 16.h),
        itemCount: controller.tripReportItems.length,
        itemBuilder: (context, index) {
          return TripReportCard(report: controller.tripReportItems[index]);
        },
      ),
    );
  }
